...
//  Quizzler-iOS13
//
//  Created by Kyle Knudson on 7/4/20.
...
struct QuizBrain {
    ...
    mutating func checkAnswer( _ userAnswer: String) -> Bool {
        if userAnswer ==   quiz[questionCount].correctAnswer {
            score += 1
            return true
        }else {
            return false
    ...
    func getAnswerSelection(choiceNum : Int) -> String {
        return quiz[questionCount].answers[choiceNum]
    }
